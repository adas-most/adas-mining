<?php
	...
	if(isset($_POST['Total_Soft_Cal_SaveEv']))
	{
		...
		$wpdb->query($wpdb->prepare("INSERT INTO $table_name6 (id, TotalSoftCal_EvDesc, TotalSoftCal_EvImg, TotalSoftCal_EvVid_Src, TotalSoftCal_EvVid_Iframe, TotalSoftCal_EvCal) VALUES (%d, %s, %s, %s, %s, %s)", '', $TotalSoftCal_EvDesc, '', '', '', $TotalSoftCalEvent[0]->id));
	}
	else if(isset($_POST['Total_Soft_Cal_UpdateEv']))
	{
		...
		$wpdb->query($wpdb->prepare("UPDATE $table_name6 set TotalSoftCal_EvDesc=%s, TotalSoftCal_EvImg=%s, TotalSoftCal_EvVid_Src=%s, TotalSoftCal_EvVid_Iframe=%s WHERE TotalSoftCal_EvCal=%s", $TotalSoftCal_EvDesc, '', '', '', $Total_SoftCal_EvUpdate));
	}
